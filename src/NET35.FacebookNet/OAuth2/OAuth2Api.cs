...
namespace FacebookNet.OAuth2
{
    ...
    /// <summary>
    /// OAuth2 operations for Facebook.
    /// </summary>
    /// <remarks>
    ...
    public class OAuth2Api : BaseApi
    {
        ...
        /// </summary>
        /// <param name="facebookApi">The linked information API.</param>
        public OAuth2Api(FacebookApi facebookApi)
            : base(facebookApi)
        {
        }
        ...
        public Uri GetAuthorizationUrl(AuthorizationScope scope, string state, string redirectUri)
        {
            ...
            var url = string.Format(
                ...
                this.FacebookApi.Configuration.BaseOAuthUrl,
                Uri.EscapeDataString(this.FacebookApi.Configuration.ApiKey),
        ...
        public AuthorizationAccessToken GetAccessToken(string authorizationCode, string redirectUri)
        {
            ...
            var url = string.Format(
                ...
                Uri.EscapeDataString(redirectUri),
                Uri.EscapeDataString(this.FacebookApi.Configuration.ApiKey),
                Uri.EscapeDataString(this.FacebookApi.Configuration.ApiSecretKey));
